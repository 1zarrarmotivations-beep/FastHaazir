-- Full Reset of Role System Dependencies
...
-- 3. Ensure ENUM type has all values (idempotent)
DO $$ BEGIN
...
-- 4. Convert/Ensure user_roles.role is app_role
ALTER TABLE public.user_roles 
  ALTER COLUMN role TYPE public.app_role 
  USING role::text::public.app_role;

-- 5. Recreate View (Updated to use ENUM cast)
