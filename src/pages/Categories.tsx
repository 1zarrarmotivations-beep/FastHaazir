...
const allCategories: Category[] = [
  ...
  { id: 'grocery', nameKey: 'categories.grocery', emoji: '🛒', gradient: 'from-green-500/20 to-emerald-500/20' },
  { id: 'bakery', nameKey: 'categories.bakery', emoji: '🥖', gradient: 'from-amber-400/20 to-orange-400/20' },
  { id: 'medical', nameKey: 'categories.medical', emoji: '💊', gradient: 'from-blue-500/20 to-cyan-500/20' },
