...
const RiderLiveMap = ({
    ...
    useEffect(() => {
        ...
        // Off-route: furthest point on polyline > 50m from rider
        const closestPolyDist = Math.min(
            ...route.polyline.map(p => {
                const pp = p as [number, number];
                return ridPos.distanceTo(L.latLng(pp[0], pp[1]));
            })
        );
        setOffRoute(closestPolyDist > 80);
            ...
            >
                            ...
                            >
                                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                                    ...
                                    <div style={{ flex: 1, minWidth: 0 }}>
                                        ...
                                        <p style={{ color: 'rgba(255,255,255,0.45)', fontSize: 11, margin: '2px 0 0', fontWeight: 600 }}>
                        ...
                        >
                            ...
                            <div style={{ flex: 1, textAlign: 'center', borderRight: '1px solid rgba(255,255,255,0.08)', paddingRight: 14 }}>
                                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 5 }}>
                                    <Clock size={13} style={{ color: '#ff6a00' }} />
                                    <span style={{ color: '#fff', fontSize: 20, fontWeight: 900, letterSpacing: '-0.5px' }}>{eta}</span>
                                </div>
                                <span style={{ color: 'rgba(255,255,255,0.35)', fontSize: 10, fontWeight: 600, letterSpacing: '0.5px' }}>ETA</span>
                            </div>
                            {/* Distance */}
                ...
                {!hasRider && (
                    <div style={{
                        ...
                        >
                            <Locate size={28} style={{ color: '#ff6a00' }} />
                        </motion.div>
                        <p style={{ color: 'rgba(255,255,255,0.8)', fontSize: 15, fontWeight: 700, margin: 0 }}>
                            Acquiring GPS signal…
                        </p>
                        <p style={{ color: 'rgba(255,255,255,0.35)', fontSize: 12, margin: 0 }}>
                            Enable location services for live navigation
                        </p>
                    </div>
                )}
            </div>
